...
select A in "XFCE base" "XFCE full" "KDE base" "KDE full" "GNOME min" "GNOME base" "GNOME extra" "i3" "info"; do case $A in
    ...
    "KDE base") XTRAPKG="plasma-desktop plasma-workspace plasma-systemmonitor systemsettings kwin kscreen powerdevil plasma-nm plasma-pa polkit-kde-agent kde-gtk-config kdeplasma-addons plasma-integration print-manager breeze flatpak-kcm plasma-activities sddm"; GRTR="sddm"; break; ;;
...
arch-chroot /mnt chsh -s $SHL $USRN
